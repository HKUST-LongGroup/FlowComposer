...
class CompositionDataset(Dataset):
    ...
    def get_split_info(self):
        ...
        # image_list = get_image_paths(self.root)
        train_data, val_data, test_data = [], [], []
        # print("image list : ",image_list[:100])
        # break
        for instance in data:
            ...
            if attr == 'NA' or (attr,
                ...
                continue
            # if image == 'coiled_brass/362-Masaai-upper-arm-bungles-Size-7-cm-3.jpg':
            #     print("whther in ",image in image_list)
            # if image not in image_list:
                # ignore instances with unlabeled images
                # continue
...
class CompositionDataset_seg(Dataset):
    def __init__(
            self,
            root,
            phase,
        ...
        self.feat_dim = None
        self.transform = transform_image(phase, imagenet=imagenet)
        self.loader = ImageLoader(self.root + f'/{folder_name}/')
...
class CompositionDataset_segMean(Dataset):
    def __init__(
            self,
            root,
            phase,
...
class CompositionDataset_u(Dataset):
    def __init__(
            self,
            root,
            phase,
